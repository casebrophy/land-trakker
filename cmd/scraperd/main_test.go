...
// TestSmoke_RunOrchestratorWithFakeBroker verifies that the orchestrator can
// successfully run one tick with FakeBroker, wiring it through the pipes.
func TestSmoke_RunOrchestratorWithFakeBroker(t *testing.T) {
